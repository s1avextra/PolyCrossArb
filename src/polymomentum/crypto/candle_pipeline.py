...
from polymomentum.crypto.candle_scanner import CandleContract, scan_candle_markets
...
from polymomentum.monitoring.alerter import (
...
from polymomentum.execution.orders import TradeOrder
...
class CandlePipeline:
                ...
                if _staleness_window:
                    ...
                    if p99_ms > _latency_threshold_ms:
                        ...
                        if _consecutive_high >= _alert_after_windows:
                            from polymomentum.monitoring.alerter import alert_latency_degradation
    ...
    async def _scan_loop(self):
        ...
        while self._running:
            ...
            # ── Hard kill switch (touch /tmp/polymomentum/KILL) ──
            ...
            for contract in self._contracts:
                ...
                # polymomentum.crypto.decision.decide_candle_trade
